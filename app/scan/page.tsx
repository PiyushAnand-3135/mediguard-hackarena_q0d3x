      ...
      <div className="container mx-auto px-4 py-6 sm:py-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold">Scan Medicine</h1>
          </div>
          {medicationData && (
        ...
        <div className="mb-6 w-full max-w-xl">
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
              value={searchInput}
          ...
          <div className="lg:col-span-1">
            <Card className="border-0 shadow-lg overflow-hidden bg-white">
              ...
              <CardHeader>
                ...
                <CardDescription>Take a clear photo of your medicine label or prescription</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            {isProcessing ? (
              <Card className="border-0 shadow-lg overflow-hidden bg-white h-full">
                ...
                <div className="flex flex-col items-center justify-center h-full p-6 sm:p-12">
                  <Loader2 className="h-12 w-12 sm:h-16 sm:w-16 text-emerald-500 animate-spin" />
                  <p className="text-lg sm:text-xl font-medium text-center mt-6">Processing your request...</p>
                ...
                <CardHeader className="border-b bg-white">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <CardTitle className="text-xl sm:text-2xl">{medicationData.name}</CardTitle>
                      <CardDescription className="text-sm sm:text-base">{medicationData.description}</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="p-0">
                  <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    <TabsList className="grid grid-cols-3 border-b bg-transparent h-auto">
                      <TabsTrigger value="composition" className="py-2 sm:py-3 text-xs sm:text-sm border-b-2 data-[state=active]:border-emerald-500">
                        Composition
                      </TabsTrigger>
                      <TabsTrigger value="alternatives" className="py-2 sm:py-3 text-xs sm:text-sm border-b-2 data-[state=active]:border-emerald-500">
                        Alternatives
                      </TabsTrigger>
                      <TabsTrigger value="interactions" className="py-2 sm:py-3 text-xs sm:text-sm border-b-2 data-[state=active]:border-emerald-500">
                        Interactions
                      </TabsTrigger>
                    </TabsList>
              ...
              <div className="flex flex-col items-center justify-center h-full p-6 sm:p-12 border-2 border-dashed border-emerald-200 rounded-lg bg-emerald-50/30">
                <div className="bg-white p-4 sm:p-6 rounded-full shadow-md mb-4 sm:mb-6">
                  <Upload className="h-8 w-8 sm:h-12 sm:w-12 text-emerald-400" />
                </div>
                <p className="text-lg sm:text-xl font-medium text-center">No image uploaded yet</p>
                <p className="text-gray-500 text-center mt-2 max-w-md">
                ...
                <button id="upload-trigger" className="hidden"></button>
              </div>
            )}
          </div>
        </div>
